...
Timing: **2:30-4:30 pm PST** on **Fridays** from **Sept 29** to **Nov 17, 2023** (**7 sessions** in total, **the Friday before fall break is skipped**)  
...
You can run the notebook for this session either at [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/AashitaK/A-Hands-On-Workshop-In-Machine-Learning-Fall-2023/HEAD) or <a target="_blank" href="https://colab.research.google.com/github/AashitaK/A-Hands-On-Workshop-In-Machine-Learning-Fall-2023/blob/main/Session%201/Data%20Manipulation%20using%20pandas.ipynb">
